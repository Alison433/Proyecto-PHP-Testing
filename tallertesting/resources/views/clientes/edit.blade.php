                ...
                <div class="col-md-8">
                    <form method="POST" action="{{ route('clientes.update', $clientes->id) }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="nombrec" name="nombrec" required value="{{ old('nombrec', $clientes->nombrec) }}">
                        </div>
                        <div class="mb-3">
                            <label for="apellidoc" class="form-label">Apellido</label>
                            <input type="text" class="form-control" id="apellidoc" name="apellidoc" required value="{{ old('apellidoc', $clientes->apellidoc) }}">
                        </div>
                        <div class="mb-3">
                            <label for="edadc" class="form-label">Edad</label>
                            <input type="number" class="form-control" id="edadc" name="edadc" required step="1" value="{{ old('edadc', $clientes->edadc) }}">
                        </div>
                        <div class="mb-3">
                            <label for="correo_electronicoc" class="form-label">Correo Electrónico</label>
                            <input type="email" class="form-control" id="correo_electronicoc" name="correo_electronicoc" required value="{{ old('correo_electronicoc', $clientes->correo_electronicoc) }}">
                        </div>
                        <div class="mb-3">
                            <label for="telefonoc" class="form-label">Teléfono</label>
                            <input type="tel" class="form-control" id="telefonoc" name="telefonoc" required pattern="[0-9]{10}" value="{{ old('telefonoc', $clientes->telefonoc) }}">
                        </div>
                        <div class="mb-3">
                            <label for="fecha_nacimientoc" class="form-label">Fecha de Nacimiento</label>
                            <input type="date" class="form-control" id="fecha_nacimientoc" name="fecha_nacimientoc" required value="{{ old('fecha_nacimientoc', $clientes->fecha_nacimientoc) }}">
                        </div>
                        <div class="mb-3">
