            ...
            <div class="col-md-8">
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr id="fila{{ $empleados->id }}">
                            <td>{{ $empleados->id }}</td>
                            <td>{{ $empleados->nombre }}</td>
                            <td>{{ $empleados->apellido }}</td>
                            <td>{{ $empleados->edad }}</td>
                            <td>{{ $empleados->correo_electronico }}</td>
                            <td>{{ $empleados->telefono }}</td>
                            <td>
                                <div class="text-end mb-3">
                                    <button type="button" class="btn btn-danger" onclick="confirmDelete('{{ $empleados->id }}')">Eliminar</button>
                                    <a href="{{ route('empleados.edit', $empleados->id)}}"  class="btn btn-success ">Editar Empleado</a>
                                </div>
                            </td>
                        </tr>
                        @endforeach
