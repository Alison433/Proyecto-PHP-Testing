                ...
                <div class="col-md-8">
                    <form method="POST" action="<?php echo e(route('clientes.store')); ?>">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="edadc" name="edadc" required step="1">
                        </div>
                        <div class="mb-3">
                            <label for="correo_electronicoc" class="form-label">Correo Electrónico</label>
                            <input type="email" class="form-control" id="correo_electronicoc" name="correo_electronicoc" required>
                        </div>
                        <div class="mb-3">
                            <label for="telefonoc" class="form-label">Teléfono</label>
                            <input type="tel" class="form-control" id="telefonoc" name="telefonoc" required pattern="[0-9]{10}">
                        </div>
                        <div class="mb-3">
                            <label for="fecha_nacimientoc" class="form-label">Fecha de Nacimiento</label>
                            <input type="date" class="form-control" id="fecha_nacimientoc" name="fecha_nacimientoc" required>
                        </div>
                        <div class="mb-3">
...
</html><?php /**PATH C:\xampp\htdocs\TallerUltimo\tallertesting\resources\views/clientes/create.blade.php ENDPATH**/ ?>