        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="text-end mb-3">
                    <a href="<?php echo e(route('servicios.create')); ?>" class="btn btn-primary">Crear Servicios</a>
                </div>
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo e($empleado->empleado); ?></td>
                            <td><?php echo e($empleado->fecha); ?></td>
                            <td><?php echo e($empleado->tipo_servicio); ?></td>
                            <td><?php echo e($empleado->cliente); ?></td>
                            <td><?php echo e($empleado->precio); ?></td>
                        </tr>
...
</html><?php /**PATH C:\xampp\htdocs\TallerUltimo\tallertesting\resources\views/servicios/index.blade.php ENDPATH**/ ?>