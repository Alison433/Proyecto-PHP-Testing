            ...
            <div class="col-md-8">
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr id="fila<?php echo e($empleados->id); ?>">
                            <td><?php echo e($empleados->id); ?></td>
                            <td><?php echo e($empleados->nombre); ?></td>
                            <td><?php echo e($empleados->apellido); ?></td>
                            <td><?php echo e($empleados->edad); ?></td>
                            <td><?php echo e($empleados->correo_electronico); ?></td>
                            <td><?php echo e($empleados->telefono); ?></td>
                            <td>
                                <div class="text-end mb-3">
                                    <button type="button" class="btn btn-danger" onclick="confirmDelete('<?php echo e($empleados->id); ?>')">Eliminar</button>
                                    <a href="<?php echo e(route('empleados.edit', $empleados->id)); ?>"  class="btn btn-success ">Editar Empleado</a>
                                </div>
                            </td>
                        </tr>
...
</html><?php /**PATH C:\xampp\htdocs\TallerUltimo\tallertesting\resources\views/empleados/index.blade.php ENDPATH**/ ?>