                ...
                <div class="col-md-8">
                    <form method="POST" action="<?php echo e(route('empleados.update', $empleado->id)); ?>">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="nombre" name="nombre" required value="<?php echo e(old('nombre', $empleado->nombre)); ?>">
                        </div>
                        <div class="mb-3">
                            <label for="apellido" class="form-label">Apellido</label>
                            <input type="text" class="form-control" id="apellido" name="apellido" required value="<?php echo e(old('apellido', $empleado->apellido)); ?>">
                        </div>
                        <div class="mb-3">
                            <label for="edad" class="form-label">Edad</label>
                            <input type="number" class="form-control" id="edad" name="edad" required step="1" value="<?php echo e(old('edad', $empleado->edad)); ?>">
                        </div>
                        <div class="mb-3">
                            <label for="correo_electronico" class="form-label">Correo Electrónico</label>
                            <input type="email" class="form-control" id="correo_electronico" name="correo_electronico" required value="<?php echo e(old('correo_electronico', $empleado->correo_electronico)); ?>">
                        </div>
                        <div class="mb-3">
                            <label for="telefono" class="form-label">Teléfono</label>
                            <input type="tel" class="form-control" id="telefono" name="telefono" required pattern="[0-9]{10}" value="<?php echo e(old('telefono', $empleado->telefono)); ?>">
                        </div>
                        <div class="mb-3">
...
</html><?php /**PATH C:\xampp\htdocs\TallerUltimo\tallertesting\resources\views/empleados/edit.blade.php ENDPATH**/ ?>